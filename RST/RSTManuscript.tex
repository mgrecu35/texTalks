...
0.0 mean and 0.5 dB standard deviation to the calculated reflectivity values.  Nevertheless, it should be noted that the
...
provided in Table \ref{t_sensors}.
...
\begin{table}
    ...
    \hline
    Lidar & 524 nm & LogNormal(0,1) & 5e-7 \\
    \hline
