...
would allow the study of atmopsheric processes at sub-daily time scales, with an emphasis on deep
...
To improve the representation of microphysical variability in the study, we don't assume the values of $N_w$ given
...
are strongly attenuated in the bottom part of the cloud.  The vertical resolutions of
...
used in the ice scattering-gas absorption collocation process.  The surface emissivities are randomly chosen between 
...
all frequencies of the 10 channels of the SAPHIR-NG 
radiometer envisioned to be deployed in the AOS mission \citep{brogniez2022time}.  One of the frequencies is 
89-GHz, while the others are centered on the 183.31, and 325.15 GHz water vapor absorption lines. Details are
provided in Table \ref{t_sensors}.  Errors in the radiometer observations are modeled assuming a 
Noise-Equivalent-Delta-T (NEDT) of 1K, which is a readily achievable level for modern satellite radiometers \cite{draper2015}.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\textwidth,angle=0]{./Figs/fig04.rev.png}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\textwidth,angle=0]{./Figs/fig05.rev.png}\\
...
being limited by its sensitivity, they are nevertheless insightful.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\textwidth,angle=0]{./Figs/fig07.rev.png}\\
